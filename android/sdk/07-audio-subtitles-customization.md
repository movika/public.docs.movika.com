...
- выполнить необходимые шаги, которые описаны в разделе кастомизации интерфейса паузы/воспроизведения: [ссылка](/android/sdk/06-play-pause-customization.md)
...
событиях плеера можно найти по ссылке: [ссылка](/android/sdk/04-player-events.md).  
