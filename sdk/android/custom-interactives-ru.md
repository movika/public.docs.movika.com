...
Опционально придумать свою структуру объекта **props**, в котором можно задавать специфичные для вашего контейнера.
Если вы планируете использовать пользовательские контролы, то необходимо проделать те же самые действия и с ними.
