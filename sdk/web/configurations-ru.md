...
| Наименование       | Обязательный | Тип     | По умолчанию | Описание                                                                                                                                                                   |
| ------------------ | ------------ | ------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| src                | Да           | String  | -            | Указывает URL-адрес видеофайла или манифеста интерактивного фильма. Поддерживает .m3u8, .mp4, .json расширения. Также работает с объектом манифеста интерактивного фильма. |
